                        ...
                        <div class="card product-card">
                            ...
                            <div class="card-body text-center mt-3">
                                ...
                                <div class="price mt-2">
                                    <span class="h5"><strong>{{ 'Rp ' . number_format($product->price * 1000, 0, ',', '.') }}</strong></span>

                                    @if($product->compare_price > 0)
                                    <span class="h6 text-underline"><del>{{ 'Rp ' . number_format($product->compare_price * 1000, 0, ',', '.') }}</del></span>
                                    @endif
...
<script>
    ...
    prettify: function (num) {
        return "Rp" + num.toLocaleString("id-ID"); // Format angka ke Rupiah
    },
    onFinish: function() {
        apply_filters()
    }
    ...
    // Kirim harga tanpa dikali 1000, karena backend udah menyesuaikan
