						...
						<form action="" method="get">
							<div class="card-header">
								<div class="card-title">
									<button type="button" onClick="window.location.href='{{ route("sub-categories.index") }}'" class="btn btn-default btn-sm">Mengatur Ulang</button>
								</div>
							...
							<div class="card-body table-responsive p-0">								
								<table class="table table-hover text-nowrap">
									...
									<tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="5">Sub Kategori Tidak Ditemukan</td>
                                            </tr>
                                        @endif 
									</tbody>
								</table>										
