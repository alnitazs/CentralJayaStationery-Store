                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="discount_amount" id="discount_amount" class="form-control" placeholder="jumlah diskon">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="slug">Min.Pembelian</label>
                                <input type="text" name="min_amount" id="min_amount" class="form-control" placeholder="jumlah minimal">
                                <p></p>
                            </div>
                        </div>
