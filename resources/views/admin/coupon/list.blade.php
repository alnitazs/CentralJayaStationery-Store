            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onClick="window.location.href='{{ route("coupons.index") }}'" class="btn btn-default btn-sm">Mengatur Ulang</button>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                Rp{{ number_format($discountCoupon->discount_amount, 0, ',', '.') }}
                                @endif
                            </td>
                        ...
                        @else
                        <tr>
                            <td colspan="5">Kategori Tidak Ditemukan</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
